...
'''
  ...
  for i in range(0,100):
      ...
      temporal = str(temperature)
      espacios = ""
      for i in range(0,16 - len(temporal)):
        espacios = espacios + " "

      temperature =  temporal + espacios
      fileData.write('"' +  temporal + '",')
      
      temporal = str(pressure)
      espacios = ""
      for i in range(0,16 - len(temporal)):
        espacios = espacios + " " 
      
      pressure = temporal + espacios
      fileData.write('"' +  temporal + '",')
